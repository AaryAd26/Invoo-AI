...
export const appShellStyles = {
  ...
  // Desktop Sidebar
  sidebar: "hidden lg:flex lg:flex-col bg-white/80 backdrop-blur-xl border-r border-gray-200/60 headerActions:transition-all duration-500 ease-in-out relative",
  ...
  // Header Actions
 headerActions: "hidden sm:flex items-center justify-between sm:justify-end gap-3 sm:gap-4 pb-3 sm:pb-0 border-t border-gray-100 sm:border-t-0 pt-3 sm:pt-0", // FIXED: added hidden sm:flex
