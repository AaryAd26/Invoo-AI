          ...
          <header className={`${appShellStyles.header} ${
              ...
              <div className={appShellStyles.headerContent}>
                ...
                <div className={appShellStyles.welcomeContainer}>
                  ...
                  <p className={appShellStyles.welcomeSubtitle}>
                    Manage your invoices and business profile
                  </p>
                </div>
              </div>
              <div className={appShellStyles.mobileUserAvatar}>
                <div className={appShellStyles.mobileAvatar}>
                  {user?.firstName?.[0] || "U"}
                </div>
              </div>
            </div>
            ...
            <div className={appShellStyles.headerActions}>
              <button onClick={() => navigate("/app/create-invoice")} className={appShellStyles.ctaButton}>
                <svg className={appShellStyles.ctaIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <div className={appShellStyles.userSectionDesktop}>
                <div className={appShellStyles.userInfo}>
                  <p className={appShellStyles.userName}>{user?.firstName} {user?.lastName}</p>
                  <p className={appShellStyles.userEmail}>{user?.emailAddresses?.[0]?.emailAddress}</p>
                </div>
